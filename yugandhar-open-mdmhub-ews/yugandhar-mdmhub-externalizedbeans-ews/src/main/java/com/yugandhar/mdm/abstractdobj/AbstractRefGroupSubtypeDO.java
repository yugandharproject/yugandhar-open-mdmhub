...
/**
 * Abstract DO class for RefGroupSubtypeDO class mapped to database REF_GROUP_SUBTYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefGroupSubtypeDO
*/

@MappedSuperclass
public abstract class AbstractRefGroupSubtypeDO implements java.io.Serializable {
	...
	public AbstractRefGroupSubtypeDO() {
	}

	public AbstractRefGroupSubtypeDO(RefGroupSubtypeDO theRefGroupSubtypeDO) {
		idPk = theRefGroupSubtypeDO.idPk;
		version = theRefGroupSubtypeDO.version;
		createdTs = theRefGroupSubtypeDO.createdTs;
		deletedTs = theRefGroupSubtypeDO.deletedTs;
		updatedTs = theRefGroupSubtypeDO.updatedTs;
		updatedByUser = theRefGroupSubtypeDO.updatedByUser;
		updatedByTxnId = theRefGroupSubtypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefGroupSubtypeDO.configLanguageCodeKey;
		key = theRefGroupSubtypeDO.key;
		value = theRefGroupSubtypeDO.value;
		description = theRefGroupSubtypeDO.description;
		inquiryFilter = theRefGroupSubtypeDO.inquiryFilter;
	}
