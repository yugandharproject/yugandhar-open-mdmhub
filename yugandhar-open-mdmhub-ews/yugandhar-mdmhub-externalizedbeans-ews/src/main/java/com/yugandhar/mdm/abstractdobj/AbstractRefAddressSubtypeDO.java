...
/**
 * Abstract DO class for RefAddressSubtypeDO class mapped to database REF_ADDRESS_SUBTYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefAddressSubtypeDO
*/

@MappedSuperclass
public abstract class AbstractRefAddressSubtypeDO implements java.io.Serializable {
	...
	public AbstractRefAddressSubtypeDO() {
	}

	public AbstractRefAddressSubtypeDO(RefAddressSubtypeDO theRefAddressSubtypeDO) {
		idPk = theRefAddressSubtypeDO.idPk;
		version = theRefAddressSubtypeDO.version;
		createdTs = theRefAddressSubtypeDO.createdTs;
		deletedTs = theRefAddressSubtypeDO.deletedTs;
		updatedTs = theRefAddressSubtypeDO.updatedTs;
		updatedByUser = theRefAddressSubtypeDO.updatedByUser;
		updatedByTxnId = theRefAddressSubtypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefAddressSubtypeDO.configLanguageCodeKey;
		key = theRefAddressSubtypeDO.key;
		value = theRefAddressSubtypeDO.value;
		description = theRefAddressSubtypeDO.description;
		inquiryFilter = theRefAddressSubtypeDO.inquiryFilter;
	}
