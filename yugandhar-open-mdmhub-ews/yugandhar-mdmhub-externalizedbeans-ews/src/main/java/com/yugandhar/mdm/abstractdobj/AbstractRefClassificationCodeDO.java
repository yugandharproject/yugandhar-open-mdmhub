...
/**
 * Abstract DO class for RefClassificationCodeDO class mapped to database REF_CLASSIFICATION_CODE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefClassificationCodeDO
*/

@MappedSuperclass
public abstract class AbstractRefClassificationCodeDO implements java.io.Serializable {
	...
	public AbstractRefClassificationCodeDO() {
	}

	public AbstractRefClassificationCodeDO(RefClassificationCodeDO theRefClassificationCodeDO) {
		idPk = theRefClassificationCodeDO.idPk;
		version = theRefClassificationCodeDO.version;
		createdTs = theRefClassificationCodeDO.createdTs;
		deletedTs = theRefClassificationCodeDO.deletedTs;
		updatedTs = theRefClassificationCodeDO.updatedTs;
		updatedByUser = theRefClassificationCodeDO.updatedByUser;
		updatedByTxnId = theRefClassificationCodeDO.updatedByTxnId;
		configLanguageCodeKey = theRefClassificationCodeDO.configLanguageCodeKey;
		key = theRefClassificationCodeDO.key;
		value = theRefClassificationCodeDO.value;
		description = theRefClassificationCodeDO.description;
		inquiryFilter = theRefClassificationCodeDO.inquiryFilter;
	}
