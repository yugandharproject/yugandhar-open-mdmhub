...
/**
 * Abstract DO class for RefPersonnameTypeDO class mapped to database REF_PERSONNAME_TYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefPersonnameTypeDO
*/

@MappedSuperclass
public abstract class AbstractRefPersonnameTypeDO implements java.io.Serializable {
	...
	public AbstractRefPersonnameTypeDO() {
	}

	public AbstractRefPersonnameTypeDO(RefPersonnameTypeDO theRefPersonnameTypeDO) {
		idPk = theRefPersonnameTypeDO.idPk;
		version = theRefPersonnameTypeDO.version;
		createdTs = theRefPersonnameTypeDO.createdTs;
		deletedTs = theRefPersonnameTypeDO.deletedTs;
		updatedTs = theRefPersonnameTypeDO.updatedTs;
		updatedByUser = theRefPersonnameTypeDO.updatedByUser;
		updatedByTxnId = theRefPersonnameTypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefPersonnameTypeDO.configLanguageCodeKey;
		key = theRefPersonnameTypeDO.key;
		value = theRefPersonnameTypeDO.value;
		description = theRefPersonnameTypeDO.description;
		inquiryFilter = theRefPersonnameTypeDO.inquiryFilter;
	}
