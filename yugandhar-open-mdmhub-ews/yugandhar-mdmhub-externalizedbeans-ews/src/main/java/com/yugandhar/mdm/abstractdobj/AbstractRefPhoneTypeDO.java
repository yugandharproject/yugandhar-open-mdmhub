...
/**
 * Abstract DO class for RefPhoneTypeDO class mapped to database REF_PHONE_TYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefPhoneTypeDO
*/

@MappedSuperclass
public abstract class AbstractRefPhoneTypeDO implements java.io.Serializable {
	...
	public AbstractRefPhoneTypeDO() {
	}

	public AbstractRefPhoneTypeDO(RefPhoneTypeDO theRefPhoneTypeDO) {
		idPk = theRefPhoneTypeDO.idPk;
		version = theRefPhoneTypeDO.version;
		createdTs = theRefPhoneTypeDO.createdTs;
		deletedTs = theRefPhoneTypeDO.deletedTs;
		updatedTs = theRefPhoneTypeDO.updatedTs;
		updatedByUser = theRefPhoneTypeDO.updatedByUser;
		updatedByTxnId = theRefPhoneTypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefPhoneTypeDO.configLanguageCodeKey;
		key = theRefPhoneTypeDO.key;
		value = theRefPhoneTypeDO.value;
		description = theRefPhoneTypeDO.description;
		inquiryFilter = theRefPhoneTypeDO.inquiryFilter;
	}
