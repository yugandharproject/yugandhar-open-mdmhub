...
/**
 * Abstract DO class for RefIdentificationTypeDO class mapped to database REF_IDENTIFICATION_TYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefIdentificationTypeDO
*/

@MappedSuperclass
public abstract class AbstractRefIdentificationTypeDO implements java.io.Serializable {
	...
	public AbstractRefIdentificationTypeDO() {
	}

	public AbstractRefIdentificationTypeDO(RefIdentificationTypeDO theRefIdentificationTypeDO) {
		idPk = theRefIdentificationTypeDO.idPk;
		version = theRefIdentificationTypeDO.version;
		createdTs = theRefIdentificationTypeDO.createdTs;
		deletedTs = theRefIdentificationTypeDO.deletedTs;
		updatedTs = theRefIdentificationTypeDO.updatedTs;
		updatedByUser = theRefIdentificationTypeDO.updatedByUser;
		updatedByTxnId = theRefIdentificationTypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefIdentificationTypeDO.configLanguageCodeKey;
		key = theRefIdentificationTypeDO.key;
		value = theRefIdentificationTypeDO.value;
		description = theRefIdentificationTypeDO.description;
		inquiryFilter = theRefIdentificationTypeDO.inquiryFilter;
	}
