...
/**
 * Abstract DO class for RefAssocTypeDO class mapped to database REF_ASSOC_TYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefAssocTypeDO
*/

@MappedSuperclass
public abstract class AbstractRefAssocTypeDO implements java.io.Serializable {
	...
	public AbstractRefAssocTypeDO() {
	}

	public AbstractRefAssocTypeDO(RefAssocTypeDO theRefAssocTypeDO) {
		idPk = theRefAssocTypeDO.idPk;
		version = theRefAssocTypeDO.version;
		createdTs = theRefAssocTypeDO.createdTs;
		deletedTs = theRefAssocTypeDO.deletedTs;
		updatedTs = theRefAssocTypeDO.updatedTs;
		updatedByUser = theRefAssocTypeDO.updatedByUser;
		updatedByTxnId = theRefAssocTypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefAssocTypeDO.configLanguageCodeKey;
		key = theRefAssocTypeDO.key;
		value = theRefAssocTypeDO.value;
		description = theRefAssocTypeDO.description;
		inquiryFilter = theRefAssocTypeDO.inquiryFilter;
	}
