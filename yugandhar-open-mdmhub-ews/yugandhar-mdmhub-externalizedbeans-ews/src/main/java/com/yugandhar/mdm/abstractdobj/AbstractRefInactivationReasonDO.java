...
/**
 * Abstract DO class for RefInactivationReasonDO class mapped to database REF_INACTIVATION_REASON entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefInactivationReasonDO
*/

@MappedSuperclass
public abstract class AbstractRefInactivationReasonDO implements java.io.Serializable {
	...
	public AbstractRefInactivationReasonDO() {
	}

	public AbstractRefInactivationReasonDO(RefInactivationReasonDO theRefInactivationReasonDO) {
		idPk = theRefInactivationReasonDO.idPk;
		version = theRefInactivationReasonDO.version;
		createdTs = theRefInactivationReasonDO.createdTs;
		deletedTs = theRefInactivationReasonDO.deletedTs;
		updatedTs = theRefInactivationReasonDO.updatedTs;
		updatedByUser = theRefInactivationReasonDO.updatedByUser;
		updatedByTxnId = theRefInactivationReasonDO.updatedByTxnId;
		configLanguageCodeKey = theRefInactivationReasonDO.configLanguageCodeKey;
		key = theRefInactivationReasonDO.key;
		value = theRefInactivationReasonDO.value;
		description = theRefInactivationReasonDO.description;
		inquiryFilter = theRefInactivationReasonDO.inquiryFilter;
	}
