...
/**
 * Abstract DO class for RefCountryIsoDO class mapped to database REF_COUNTRY_ISO entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefCountryIsoDO
*/

@MappedSuperclass
public abstract class AbstractRefCountryIsoDO implements java.io.Serializable {
	...
	public AbstractRefCountryIsoDO() {
	}

	public AbstractRefCountryIsoDO(RefCountryIsoDO theRefCountryIsoDO) {
		idPk = theRefCountryIsoDO.idPk;
		version = theRefCountryIsoDO.version;
		createdTs = theRefCountryIsoDO.createdTs;
		deletedTs = theRefCountryIsoDO.deletedTs;
		updatedTs = theRefCountryIsoDO.updatedTs;
		updatedByUser = theRefCountryIsoDO.updatedByUser;
		updatedByTxnId = theRefCountryIsoDO.updatedByTxnId;
		configLanguageCodeKey = theRefCountryIsoDO.configLanguageCodeKey;
		key = theRefCountryIsoDO.key;
		value = theRefCountryIsoDO.value;
		description = theRefCountryIsoDO.description;
		inquiryFilter = theRefCountryIsoDO.inquiryFilter;
	}
