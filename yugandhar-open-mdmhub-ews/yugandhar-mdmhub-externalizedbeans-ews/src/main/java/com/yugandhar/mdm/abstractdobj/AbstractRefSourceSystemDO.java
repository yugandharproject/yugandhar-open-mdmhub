...
/**
 * Abstract DO class for RefSourceSystemDO class mapped to database REF_SOURCE_SYSTEM entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefSourceSystemDO
*/

@MappedSuperclass
public abstract class AbstractRefSourceSystemDO implements java.io.Serializable {
	...
	public AbstractRefSourceSystemDO() {
	}

	public AbstractRefSourceSystemDO(RefSourceSystemDO theRefSourceSystemDO) {
		idPk = theRefSourceSystemDO.idPk;
		version = theRefSourceSystemDO.version;
		createdTs = theRefSourceSystemDO.createdTs;
		deletedTs = theRefSourceSystemDO.deletedTs;
		updatedTs = theRefSourceSystemDO.updatedTs;
		updatedByUser = theRefSourceSystemDO.updatedByUser;
		updatedByTxnId = theRefSourceSystemDO.updatedByTxnId;
		configLanguageCodeKey = theRefSourceSystemDO.configLanguageCodeKey;
		key = theRefSourceSystemDO.key;
		value = theRefSourceSystemDO.value;
		description = theRefSourceSystemDO.description;
		inquiryFilter = theRefSourceSystemDO.inquiryFilter;
	}
