...
/**
 * Abstract DO class for RefPhoneSubtypeDO class mapped to database REF_PHONE_SUBTYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefPhoneSubtypeDO
*/

@MappedSuperclass
public abstract class AbstractRefPhoneSubtypeDO implements java.io.Serializable {
	...
	public AbstractRefPhoneSubtypeDO() {
	}

	public AbstractRefPhoneSubtypeDO(RefPhoneSubtypeDO theRefPhoneSubtypeDO) {
		idPk = theRefPhoneSubtypeDO.idPk;
		version = theRefPhoneSubtypeDO.version;
		createdTs = theRefPhoneSubtypeDO.createdTs;
		deletedTs = theRefPhoneSubtypeDO.deletedTs;
		updatedTs = theRefPhoneSubtypeDO.updatedTs;
		updatedByUser = theRefPhoneSubtypeDO.updatedByUser;
		updatedByTxnId = theRefPhoneSubtypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefPhoneSubtypeDO.configLanguageCodeKey;
		key = theRefPhoneSubtypeDO.key;
		value = theRefPhoneSubtypeDO.value;
		description = theRefPhoneSubtypeDO.description;
		inquiryFilter = theRefPhoneSubtypeDO.inquiryFilter;
	}
