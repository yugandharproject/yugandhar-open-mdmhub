...
/**
 * Abstract DO class for RefBatchProposedActionDO class mapped to database REF_BATCH_PROPOSED_ACTION entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefBatchProposedActionDO
*/

@MappedSuperclass
public abstract class AbstractRefBatchProposedActionDO implements java.io.Serializable {
	...
	public AbstractRefBatchProposedActionDO() {
	}

	public AbstractRefBatchProposedActionDO(RefBatchProposedActionDO theRefBatchProposedActionDO) {
		idPk = theRefBatchProposedActionDO.idPk;
		version = theRefBatchProposedActionDO.version;
		createdTs = theRefBatchProposedActionDO.createdTs;
		deletedTs = theRefBatchProposedActionDO.deletedTs;
		updatedTs = theRefBatchProposedActionDO.updatedTs;
		updatedByUser = theRefBatchProposedActionDO.updatedByUser;
		updatedByTxnId = theRefBatchProposedActionDO.updatedByTxnId;
		configLanguageCodeKey = theRefBatchProposedActionDO.configLanguageCodeKey;
		key = theRefBatchProposedActionDO.key;
		value = theRefBatchProposedActionDO.value;
		description = theRefBatchProposedActionDO.description;
		inquiryFilter = theRefBatchProposedActionDO.inquiryFilter;
	}
