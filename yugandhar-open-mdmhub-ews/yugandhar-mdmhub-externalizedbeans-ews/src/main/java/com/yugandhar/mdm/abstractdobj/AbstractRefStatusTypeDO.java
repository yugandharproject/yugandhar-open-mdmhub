...
/**
 * Abstract DO class for RefStatusTypeDO class mapped to database REF_STATUS_TYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefStatusTypeDO
*/

@MappedSuperclass
public abstract class AbstractRefStatusTypeDO implements java.io.Serializable {
	...
	public AbstractRefStatusTypeDO() {
	}

	public AbstractRefStatusTypeDO(RefStatusTypeDO theRefStatusTypeDO) {
		idPk = theRefStatusTypeDO.idPk;
		version = theRefStatusTypeDO.version;
		createdTs = theRefStatusTypeDO.createdTs;
		deletedTs = theRefStatusTypeDO.deletedTs;
		updatedTs = theRefStatusTypeDO.updatedTs;
		updatedByUser = theRefStatusTypeDO.updatedByUser;
		updatedByTxnId = theRefStatusTypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefStatusTypeDO.configLanguageCodeKey;
		key = theRefStatusTypeDO.key;
		value = theRefStatusTypeDO.value;
		description = theRefStatusTypeDO.description;
		inquiryFilter = theRefStatusTypeDO.inquiryFilter;
	}
