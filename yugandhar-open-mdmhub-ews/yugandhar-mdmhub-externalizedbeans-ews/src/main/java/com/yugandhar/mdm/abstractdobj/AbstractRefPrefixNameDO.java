...
/**
 * Abstract DO class for RefPrefixNameDO class mapped to database REF_PREFIX_NAME entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefPrefixNameDO
*/

@MappedSuperclass
public abstract class AbstractRefPrefixNameDO implements java.io.Serializable {
	...
	public AbstractRefPrefixNameDO() {
	}

	public AbstractRefPrefixNameDO(RefPrefixNameDO theRefPrefixNameDO) {
		idPk = theRefPrefixNameDO.idPk;
		version = theRefPrefixNameDO.version;
		createdTs = theRefPrefixNameDO.createdTs;
		deletedTs = theRefPrefixNameDO.deletedTs;
		updatedTs = theRefPrefixNameDO.updatedTs;
		updatedByUser = theRefPrefixNameDO.updatedByUser;
		updatedByTxnId = theRefPrefixNameDO.updatedByTxnId;
		configLanguageCodeKey = theRefPrefixNameDO.configLanguageCodeKey;
		key = theRefPrefixNameDO.key;
		value = theRefPrefixNameDO.value;
		description = theRefPrefixNameDO.description;
		inquiryFilter = theRefPrefixNameDO.inquiryFilter;
	}
