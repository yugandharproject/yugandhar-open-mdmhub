...
/**
 * Abstract DO class for RefLeRoletypeDO class mapped to database REF_LE_ROLETYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefLeRoletypeDO
*/

@MappedSuperclass
public abstract class AbstractRefLeRoletypeDO implements java.io.Serializable {
	...
	public AbstractRefLeRoletypeDO() {
	}

	public AbstractRefLeRoletypeDO(RefLeRoletypeDO theRefLeRoletypeDO) {
		idPk = theRefLeRoletypeDO.idPk;
		version = theRefLeRoletypeDO.version;
		createdTs = theRefLeRoletypeDO.createdTs;
		deletedTs = theRefLeRoletypeDO.deletedTs;
		updatedTs = theRefLeRoletypeDO.updatedTs;
		updatedByUser = theRefLeRoletypeDO.updatedByUser;
		updatedByTxnId = theRefLeRoletypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefLeRoletypeDO.configLanguageCodeKey;
		key = theRefLeRoletypeDO.key;
		value = theRefLeRoletypeDO.value;
		description = theRefLeRoletypeDO.description;
		inquiryFilter = theRefLeRoletypeDO.inquiryFilter;
	}
