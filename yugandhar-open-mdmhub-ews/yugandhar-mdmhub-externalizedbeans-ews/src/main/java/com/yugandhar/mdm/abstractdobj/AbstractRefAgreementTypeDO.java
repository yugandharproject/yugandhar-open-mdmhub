...
/**
 * Abstract DO class for RefAgreementTypeDO class mapped to database REF_AGREEMENT_TYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefAgreementTypeDO
*/

@MappedSuperclass
public abstract class AbstractRefAgreementTypeDO implements java.io.Serializable {
	...
	public AbstractRefAgreementTypeDO() {
	}

	public AbstractRefAgreementTypeDO(RefAgreementTypeDO theRefAgreementTypeDO) {
		idPk = theRefAgreementTypeDO.idPk;
		version = theRefAgreementTypeDO.version;
		createdTs = theRefAgreementTypeDO.createdTs;
		deletedTs = theRefAgreementTypeDO.deletedTs;
		updatedTs = theRefAgreementTypeDO.updatedTs;
		updatedByUser = theRefAgreementTypeDO.updatedByUser;
		updatedByTxnId = theRefAgreementTypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefAgreementTypeDO.configLanguageCodeKey;
		key = theRefAgreementTypeDO.key;
		value = theRefAgreementTypeDO.value;
		description = theRefAgreementTypeDO.description;
		inquiryFilter = theRefAgreementTypeDO.inquiryFilter;
	}
