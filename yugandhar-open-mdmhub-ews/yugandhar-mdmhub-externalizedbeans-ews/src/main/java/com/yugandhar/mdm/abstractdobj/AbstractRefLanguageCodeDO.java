...
/**
 * Abstract DO class for RefLanguageCodeDO class mapped to database REF_LANGUAGE_CODE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefLanguageCodeDO
*/

@MappedSuperclass
public abstract class AbstractRefLanguageCodeDO implements java.io.Serializable {
	...
	public AbstractRefLanguageCodeDO() {
	}

	public AbstractRefLanguageCodeDO(RefLanguageCodeDO theRefLanguageCodeDO) {
		idPk = theRefLanguageCodeDO.idPk;
		version = theRefLanguageCodeDO.version;
		createdTs = theRefLanguageCodeDO.createdTs;
		deletedTs = theRefLanguageCodeDO.deletedTs;
		updatedTs = theRefLanguageCodeDO.updatedTs;
		updatedByUser = theRefLanguageCodeDO.updatedByUser;
		updatedByTxnId = theRefLanguageCodeDO.updatedByTxnId;
		configLanguageCodeKey = theRefLanguageCodeDO.configLanguageCodeKey;
		key = theRefLanguageCodeDO.key;
		value = theRefLanguageCodeDO.value;
		description = theRefLanguageCodeDO.description;
		inquiryFilter = theRefLanguageCodeDO.inquiryFilter;
	}
