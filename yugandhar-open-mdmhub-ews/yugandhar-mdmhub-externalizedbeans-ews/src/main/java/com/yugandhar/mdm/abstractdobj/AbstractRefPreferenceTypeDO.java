...
/**
 * Abstract DO class for RefPreferenceTypeDO class mapped to database REF_PREFERENCE_TYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefPreferenceTypeDO
*/

@MappedSuperclass
public abstract class AbstractRefPreferenceTypeDO implements java.io.Serializable {
	...
	public AbstractRefPreferenceTypeDO() {
	}

	public AbstractRefPreferenceTypeDO(RefPreferenceTypeDO theRefPreferenceTypeDO) {
		idPk = theRefPreferenceTypeDO.idPk;
		version = theRefPreferenceTypeDO.version;
		createdTs = theRefPreferenceTypeDO.createdTs;
		deletedTs = theRefPreferenceTypeDO.deletedTs;
		updatedTs = theRefPreferenceTypeDO.updatedTs;
		updatedByUser = theRefPreferenceTypeDO.updatedByUser;
		updatedByTxnId = theRefPreferenceTypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefPreferenceTypeDO.configLanguageCodeKey;
		key = theRefPreferenceTypeDO.key;
		value = theRefPreferenceTypeDO.value;
		description = theRefPreferenceTypeDO.description;
		inquiryFilter = theRefPreferenceTypeDO.inquiryFilter;
	}
