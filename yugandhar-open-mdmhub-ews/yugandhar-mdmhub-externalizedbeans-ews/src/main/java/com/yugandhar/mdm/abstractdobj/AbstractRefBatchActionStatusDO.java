...
/**
 * Abstract DO class for RefBatchActionStatusDO class mapped to database REF_BATCH_ACTION_STATUS entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefBatchActionStatusDO
*/

@MappedSuperclass
public abstract class AbstractRefBatchActionStatusDO implements java.io.Serializable {
	...
	public AbstractRefBatchActionStatusDO() {
	}

	public AbstractRefBatchActionStatusDO(RefBatchActionStatusDO theRefBatchActionStatusDO) {
		idPk = theRefBatchActionStatusDO.idPk;
		version = theRefBatchActionStatusDO.version;
		createdTs = theRefBatchActionStatusDO.createdTs;
		deletedTs = theRefBatchActionStatusDO.deletedTs;
		updatedTs = theRefBatchActionStatusDO.updatedTs;
		updatedByUser = theRefBatchActionStatusDO.updatedByUser;
		updatedByTxnId = theRefBatchActionStatusDO.updatedByTxnId;
		configLanguageCodeKey = theRefBatchActionStatusDO.configLanguageCodeKey;
		key = theRefBatchActionStatusDO.key;
		value = theRefBatchActionStatusDO.value;
		description = theRefBatchActionStatusDO.description;
		inquiryFilter = theRefBatchActionStatusDO.inquiryFilter;
	}
