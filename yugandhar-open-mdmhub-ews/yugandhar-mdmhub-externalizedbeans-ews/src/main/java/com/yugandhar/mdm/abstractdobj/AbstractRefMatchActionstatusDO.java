...
/**
 * Abstract DO class for RefMatchActionstatusDO class mapped to database REF_MATCH_ACTIONSTATUS entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefMatchActionstatusDO
*/

@MappedSuperclass
public abstract class AbstractRefMatchActionstatusDO implements java.io.Serializable {
	...
	public AbstractRefMatchActionstatusDO() {
	}

	public AbstractRefMatchActionstatusDO(RefMatchActionstatusDO theRefMatchActionstatusDO) {
		idPk = theRefMatchActionstatusDO.idPk;
		version = theRefMatchActionstatusDO.version;
		createdTs = theRefMatchActionstatusDO.createdTs;
		deletedTs = theRefMatchActionstatusDO.deletedTs;
		updatedTs = theRefMatchActionstatusDO.updatedTs;
		updatedByUser = theRefMatchActionstatusDO.updatedByUser;
		updatedByTxnId = theRefMatchActionstatusDO.updatedByTxnId;
		configLanguageCodeKey = theRefMatchActionstatusDO.configLanguageCodeKey;
		key = theRefMatchActionstatusDO.key;
		value = theRefMatchActionstatusDO.value;
		description = theRefMatchActionstatusDO.description;
		inquiryFilter = theRefMatchActionstatusDO.inquiryFilter;
	}
