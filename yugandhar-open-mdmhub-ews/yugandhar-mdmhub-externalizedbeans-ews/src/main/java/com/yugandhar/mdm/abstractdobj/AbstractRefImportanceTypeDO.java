...
/**
 * Abstract DO class for RefImportanceTypeDO class mapped to database REF_IMPORTANCE_TYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefImportanceTypeDO
*/

@MappedSuperclass
public abstract class AbstractRefImportanceTypeDO implements java.io.Serializable {
	...
	public AbstractRefImportanceTypeDO() {
	}

	public AbstractRefImportanceTypeDO(RefImportanceTypeDO theRefImportanceTypeDO) {
		idPk = theRefImportanceTypeDO.idPk;
		version = theRefImportanceTypeDO.version;
		createdTs = theRefImportanceTypeDO.createdTs;
		deletedTs = theRefImportanceTypeDO.deletedTs;
		updatedTs = theRefImportanceTypeDO.updatedTs;
		updatedByUser = theRefImportanceTypeDO.updatedByUser;
		updatedByTxnId = theRefImportanceTypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefImportanceTypeDO.configLanguageCodeKey;
		key = theRefImportanceTypeDO.key;
		value = theRefImportanceTypeDO.value;
		description = theRefImportanceTypeDO.description;
		inquiryFilter = theRefImportanceTypeDO.inquiryFilter;
	}
