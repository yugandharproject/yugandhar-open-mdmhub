...
/**
 * Abstract DO class for RefAccountSourceStatusDO class mapped to database REF_ACCOUNT_SOURCE_STATUS entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefAccountSourceStatusDO
*/

@MappedSuperclass
public abstract class AbstractRefAccountSourceStatusDO implements java.io.Serializable {
	...
	public AbstractRefAccountSourceStatusDO() {
	}

	public AbstractRefAccountSourceStatusDO(RefAccountSourceStatusDO theRefAccountSourceStatusDO) {
		idPk = theRefAccountSourceStatusDO.idPk;
		version = theRefAccountSourceStatusDO.version;
		createdTs = theRefAccountSourceStatusDO.createdTs;
		deletedTs = theRefAccountSourceStatusDO.deletedTs;
		updatedTs = theRefAccountSourceStatusDO.updatedTs;
		updatedByUser = theRefAccountSourceStatusDO.updatedByUser;
		updatedByTxnId = theRefAccountSourceStatusDO.updatedByTxnId;
		configLanguageCodeKey = theRefAccountSourceStatusDO.configLanguageCodeKey;
		key = theRefAccountSourceStatusDO.key;
		value = theRefAccountSourceStatusDO.value;
		description = theRefAccountSourceStatusDO.description;
		inquiryFilter = theRefAccountSourceStatusDO.inquiryFilter;
	}
