...
/**
 * Abstract DO class for RefIndustryCodeDO class mapped to database REF_INDUSTRY_CODE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefIndustryCodeDO
*/

@MappedSuperclass
public abstract class AbstractRefIndustryCodeDO implements java.io.Serializable {
	...
	public AbstractRefIndustryCodeDO() {
	}

	public AbstractRefIndustryCodeDO(RefIndustryCodeDO theRefIndustryCodeDO) {
		idPk = theRefIndustryCodeDO.idPk;
		version = theRefIndustryCodeDO.version;
		createdTs = theRefIndustryCodeDO.createdTs;
		deletedTs = theRefIndustryCodeDO.deletedTs;
		updatedTs = theRefIndustryCodeDO.updatedTs;
		updatedByUser = theRefIndustryCodeDO.updatedByUser;
		updatedByTxnId = theRefIndustryCodeDO.updatedByTxnId;
		configLanguageCodeKey = theRefIndustryCodeDO.configLanguageCodeKey;
		key = theRefIndustryCodeDO.key;
		value = theRefIndustryCodeDO.value;
		description = theRefIndustryCodeDO.description;
		inquiryFilter = theRefIndustryCodeDO.inquiryFilter;
	}
