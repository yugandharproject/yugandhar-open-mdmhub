...
/**
 * Abstract DO class for RefCorporationTypeDO class mapped to database REF_CORPORATION_TYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefCorporationTypeDO
*/

@MappedSuperclass
public abstract class AbstractRefCorporationTypeDO implements java.io.Serializable {
	...
	public AbstractRefCorporationTypeDO() {
	}

	public AbstractRefCorporationTypeDO(RefCorporationTypeDO theRefCorporationTypeDO) {
		idPk = theRefCorporationTypeDO.idPk;
		version = theRefCorporationTypeDO.version;
		createdTs = theRefCorporationTypeDO.createdTs;
		deletedTs = theRefCorporationTypeDO.deletedTs;
		updatedTs = theRefCorporationTypeDO.updatedTs;
		updatedByUser = theRefCorporationTypeDO.updatedByUser;
		updatedByTxnId = theRefCorporationTypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefCorporationTypeDO.configLanguageCodeKey;
		key = theRefCorporationTypeDO.key;
		value = theRefCorporationTypeDO.value;
		description = theRefCorporationTypeDO.description;
		inquiryFilter = theRefCorporationTypeDO.inquiryFilter;
	}
