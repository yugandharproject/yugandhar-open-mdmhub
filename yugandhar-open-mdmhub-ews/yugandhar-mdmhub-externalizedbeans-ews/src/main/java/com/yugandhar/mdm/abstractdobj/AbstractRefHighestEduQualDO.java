...
/**
 * Abstract DO class for RefHighestEduQualDO class mapped to database REF_HIGHEST_EDU_QUAL entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefHighestEduQualDO
*/

@MappedSuperclass
public abstract class AbstractRefHighestEduQualDO implements java.io.Serializable {
	...
	public AbstractRefHighestEduQualDO() {
	}

	public AbstractRefHighestEduQualDO(RefHighestEduQualDO theRefHighestEduQualDO) {
		idPk = theRefHighestEduQualDO.idPk;
		version = theRefHighestEduQualDO.version;
		createdTs = theRefHighestEduQualDO.createdTs;
		deletedTs = theRefHighestEduQualDO.deletedTs;
		updatedTs = theRefHighestEduQualDO.updatedTs;
		updatedByUser = theRefHighestEduQualDO.updatedByUser;
		updatedByTxnId = theRefHighestEduQualDO.updatedByTxnId;
		configLanguageCodeKey = theRefHighestEduQualDO.configLanguageCodeKey;
		key = theRefHighestEduQualDO.key;
		value = theRefHighestEduQualDO.value;
		description = theRefHighestEduQualDO.description;
		inquiryFilter = theRefHighestEduQualDO.inquiryFilter;
	}
