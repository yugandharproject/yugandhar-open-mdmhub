...
@Service("com.yugandhar.mdm.composite.service.CreateLePropertyService")
public class CreateLePropertyService {
	...
	TxnPayload transitTxnPayload;
		...
		public CreateLePropertyService() {
		...
		public TxnTransferObj process(TxnTransferObj txnTransferObj) throws YugandharCommonException {
			...
			try {
				...
				// if Property Id is null then process Property Object
				...
				transitTxnTransferObj.setTxnPayload(transitTxnPayload);
				transitTxnTransferObj = lePropertyAssocComponent.persist(transitTxnTransferObj);
