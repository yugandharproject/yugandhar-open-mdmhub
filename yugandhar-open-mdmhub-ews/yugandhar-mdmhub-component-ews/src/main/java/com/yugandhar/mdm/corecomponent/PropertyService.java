...
@Service("com.yugandhar.mdm.corecomponent.PropertyService")
public class PropertyService {
 ...
 CommonValidationUtil commonValidationUtil;
	...
	@Autowired
	private PropertyComponent thePropertyComponent;
	...
	*@throws YugandharCommonException if PropertyDO object is not present in the request or other mandatory attributes not present
	*
	*/
	@Transactional
	public TxnTransferObj add(TxnTransferObj txnTransferObj) throws YugandharCommonException {
		...
		try {
			respTxnTransferObj = thePropertyComponent.persist(txnTransferObj);
		} catch (YugandharCommonException yce) {
			logger.error("PropertyService.add failed", yce);
			throw yce;
		} catch (Exception e) {
			//write the logic to get error message based on error code. Error code is hard-coded here
			logger.error("PropertyService.add failed", e);
			e.printStackTrace();
			throw commonValidationUtil.populateErrorResponse(txnTransferObj, "1", e,
					"PropertyService.add failed unexpectedly");
	...
	*@throws YugandharCommonException if PropertyDO object is not present in the request or mandatory attributes primary key is not present
	*/
	@Transactional
	public TxnTransferObj merge(TxnTransferObj txnTransferObj) throws YugandharCommonException {
		TxnTransferObj respTxnTransferObj;
		try {
			respTxnTransferObj = thePropertyComponent.merge(txnTransferObj);
		} catch (YugandharCommonException yce) {
			logger.error("PropertyService.merge failed", yce);
			throw yce;
		} catch (Exception e) {
			//write the logic to get error message based on error code. Error code is hard-coded here
			logger.error("PropertyService.merge failed", e);
			e.printStackTrace();
			throw commonValidationUtil.populateErrorResponse(txnTransferObj, "1", e,
					"PropertyService.merge failed unexpectedly");
	...
	*/
	...
	public TxnTransferObj findById(TxnTransferObj txnTransferObj) throws YugandharCommonException {
		TxnTransferObj respTxnTransferObj;
		try {
			respTxnTransferObj = thePropertyComponent.findById(txnTransferObj);
		} catch (YugandharCommonException yce) {
			logger.error("PropertyService.findById failed", yce);
			throw yce;
		} catch (Exception e) {
			//write the logic to get error message based on error code. Error code is hard-coded here
			logger.error("PropertyService.findById failed", e);
			e.printStackTrace();
			throw commonValidationUtil.populateErrorResponse(txnTransferObj, "1", e,
					"PropertyService.findById failed unexpectedly");
