...
@Service("com.yugandhar.mdm.config.langcode.ConfigLanguageCodeService")
public class ConfigLanguageCodeService {
	...
	@Autowired
	private ConfigLanguageCodeComponent theConfigLanguageCodeComponent;

	public ConfigLanguageCodeService() {
	...
	*/
	...
	public TxnTransferObj add(TxnTransferObj txnTransferObj) throws YugandharCommonException {
		...
		try {
			respTxnTransferObj = theConfigLanguageCodeComponent.persist(txnTransferObj);
		} catch (YugandharCommonException yce) {
			logger.error("ConfigLanguageCodeService.add failed", yce);
			throw yce;
		} catch (Exception e) {
			//write the logic to get error message based on error code. Error code is hard-coded here
			logger.error("ConfigLanguageCodeService.add failed", e);
			e.printStackTrace();
			throw commonValidationUtil.populateErrorResponse(txnTransferObj, "1", e,
					"ConfigLanguageCodeService.add failed unexpectedly");
	...
	*/
	...
	public TxnTransferObj merge(TxnTransferObj txnTransferObj) throws YugandharCommonException {
		TxnTransferObj respTxnTransferObj;
		try {
			respTxnTransferObj = theConfigLanguageCodeComponent.merge(txnTransferObj);
		} catch (YugandharCommonException yce) {
			logger.error("ConfigLanguageCodeService.merge failed", yce);
			throw yce;
		} catch (Exception e) {
			//write the logic to get error message based on error code. Error code is hard-coded here
			logger.error("ConfigLanguageCodeService.merge failed", e);
			e.printStackTrace();
			throw commonValidationUtil.populateErrorResponse(txnTransferObj, "1", e,
					"ConfigLanguageCodeService.merge failed unexpectedly");
	...
	*/
	...
	public TxnTransferObj findById(TxnTransferObj txnTransferObj) throws YugandharCommonException {
		TxnTransferObj respTxnTransferObj;
		try {
			respTxnTransferObj = theConfigLanguageCodeComponent.findById(txnTransferObj);
		} catch (YugandharCommonException yce) {
			logger.error("ConfigLanguageCodeService.findById failed", yce);
			throw yce;
		} catch (Exception e) {
			//write the logic to get error message based on error code. Error code is hard-coded here
			logger.error("ConfigLanguageCodeService.findById failed", e);
			e.printStackTrace();
			throw commonValidationUtil.populateErrorResponse(txnTransferObj, "1", e,
					"ConfigLanguageCodeService.findById failed unexpectedly");
	...
	*/
	...
	public TxnTransferObj findByBusinessKey(TxnTransferObj txnTransferObj) throws YugandharCommonException {
		TxnTransferObj respTxnTransferObj;
		try {
			respTxnTransferObj = theConfigLanguageCodeComponent.findByBusinessKey(txnTransferObj);
		} catch (YugandharCommonException yce) {
			logger.error("ConfigLanguageCodeService.findByBusinessKey failed", yce);
			throw yce;
		} catch (Exception e) {
			//write the logic to get error message based on error code. Error code is hard-coded here
			logger.error("ConfigLanguageCodeService.findByBusinessKey failed", e);
			e.printStackTrace();
			throw commonValidationUtil.populateErrorResponse(txnTransferObj, "1", e,
					"ConfigLanguageCodeService.findByBusinessKey failed unexpectedly");
	 ...
	 *	@param txnTransferObj  Transfer Object TxnTransferObj instance 
	 *	@return txnTransferObj Returns the Transfer Object TxnTransferObj instance populated with list of ConfigLanguageCodeDO objects
	 */
	@Transactional(readOnly = true)
	public TxnTransferObj findAllRecords(TxnTransferObj txnTransferObj) throws YugandharCommonException {
		try {
			txnTransferObj = theConfigLanguageCodeComponent.findAllRecords(txnTransferObj);
		} catch (YugandharCommonException yce) {
			logger.error("ConfigLanguageCodeService.findAllRecords failed", yce);
			throw yce;
		} catch (Exception e) {
			//write the logic to get error message based on error code. Error code is hard-coded here
			logger.error("ConfigLanguageCodeService.findAllRecords failed", e);
			e.printStackTrace();
			throw commonValidationUtil.populateErrorResponse(txnTransferObj, "1", e,
					"ConfigLanguageCodeService.findAllRecords failed unexpectedly");
