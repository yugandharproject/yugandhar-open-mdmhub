...
@Service("com.yugandhar.mdm.composite.service.UpdateLePhoneService")
public class UpdateLePhoneService {
			...
			try {
				...
				if (null != reqLePhoneAssocDO) {
					...
					if (null != reqLePhoneAssocDO.getPhoneStandardizedDO()) {
						...
						if(reqLePhoneAssocDO.getPhoneStandardizedDO().getIdPk() == null || reqLePhoneAssocDO.getPhoneStandardizedDO().getIdPk().isEmpty())
						{
				...
				transitTxnTransferObj.setTxnPayload(transitTxnPayload);
				transitTxnTransferObj = lePhoneAssocComponent.merge(transitTxnTransferObj);
				respLePhoneAssocDO = transitTxnTransferObj.getTxnPayload().getLePhoneAssocDO();
				respLePhoneAssocDO.setPhoneStandardizedDO(respPhoneStandardizedDO);
