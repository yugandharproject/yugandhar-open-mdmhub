...
@Service("com.yugandhar.mdm.corecomponent.LeCorporationService")
public class LeCorporationService {
 ...
 CommonValidationUtil commonValidationUtil;
	...
	@Autowired
	private LeCorporationComponent theLeCorporationComponent;

	public LeCorporationService() {
	...
	*@throws YugandharCommonException if LeCorporationDO object is not present in the request or other mandatory attributes not present
	*
	*/
	@Transactional
	public TxnTransferObj add(TxnTransferObj txnTransferObj) throws YugandharCommonException {
		...
		try {
			respTxnTransferObj = theLeCorporationComponent.persist(txnTransferObj);
		} catch (YugandharCommonException yce) {
			logger.error("LeCorporationService.add failed", yce);
			throw yce;
		} catch (Exception e) {
			//write the logic to get error message based on error code. Error code is hard-coded here
			logger.error("LeCorporationService.add failed", e);
			e.printStackTrace();
			throw commonValidationUtil.populateErrorResponse(txnTransferObj, "1", e,
					"LeCorporationService.add failed unexpectedly");
	...
	*@throws YugandharCommonException if LeCorporationDO object is not present in the request or mandatory attributes primary key is not present
	*/
	@Transactional
	public TxnTransferObj merge(TxnTransferObj txnTransferObj) throws YugandharCommonException {
		TxnTransferObj respTxnTransferObj;
		try {
			respTxnTransferObj = theLeCorporationComponent.merge(txnTransferObj);
		} catch (YugandharCommonException yce) {
			logger.error("LeCorporationService.merge failed", yce);
			throw yce;
		} catch (Exception e) {
			//write the logic to get error message based on error code. Error code is hard-coded here
			logger.error("LeCorporationService.merge failed", e);
			e.printStackTrace();
			throw commonValidationUtil.populateErrorResponse(txnTransferObj, "1", e,
					"LeCorporationService.merge failed unexpectedly");
	...
	*/
	...
	public TxnTransferObj findById(TxnTransferObj txnTransferObj) throws YugandharCommonException {
		TxnTransferObj respTxnTransferObj;
		try {
			respTxnTransferObj = theLeCorporationComponent.findById(txnTransferObj);
		} catch (YugandharCommonException yce) {
			logger.error("LeCorporationService.findById failed", yce);
			throw yce;
		} catch (Exception e) {
			//write the logic to get error message based on error code. Error code is hard-coded here
			logger.error("LeCorporationService.findById failed", e);
			e.printStackTrace();
			throw commonValidationUtil.populateErrorResponse(txnTransferObj, "1", e,
					"LeCorporationService.findById failed unexpectedly");
