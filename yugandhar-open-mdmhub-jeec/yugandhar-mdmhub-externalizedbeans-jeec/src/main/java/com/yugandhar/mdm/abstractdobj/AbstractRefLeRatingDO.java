...
/**
 * Abstract DO class for RefLeRatingDO class mapped to database REF_LE_RATING entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefLeRatingDO
*/

@MappedSuperclass
public abstract class AbstractRefLeRatingDO implements java.io.Serializable {
	...
	public AbstractRefLeRatingDO() {
	}

	public AbstractRefLeRatingDO(RefLeRatingDO theRefLeRatingDO) {
		idPk = theRefLeRatingDO.idPk;
		version = theRefLeRatingDO.version;
		createdTs = theRefLeRatingDO.createdTs;
		deletedTs = theRefLeRatingDO.deletedTs;
		updatedTs = theRefLeRatingDO.updatedTs;
		updatedByUser = theRefLeRatingDO.updatedByUser;
		updatedByTxnId = theRefLeRatingDO.updatedByTxnId;
		configLanguageCodeKey = theRefLeRatingDO.configLanguageCodeKey;
		key = theRefLeRatingDO.key;
		value = theRefLeRatingDO.value;
		description = theRefLeRatingDO.description;
		inquiryFilter = theRefLeRatingDO.inquiryFilter;
	}
