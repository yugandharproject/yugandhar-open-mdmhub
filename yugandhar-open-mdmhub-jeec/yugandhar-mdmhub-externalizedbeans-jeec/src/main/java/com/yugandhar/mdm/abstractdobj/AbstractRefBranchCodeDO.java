...
/**
 * Abstract DO class for RefBranchCodeDO class mapped to database REF_BRANCH_CODE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefBranchCodeDO
*/

@MappedSuperclass
public abstract class AbstractRefBranchCodeDO implements java.io.Serializable {
	...
	public AbstractRefBranchCodeDO() {
	}

	public AbstractRefBranchCodeDO(RefBranchCodeDO theRefBranchCodeDO) {
		idPk = theRefBranchCodeDO.idPk;
		version = theRefBranchCodeDO.version;
		createdTs = theRefBranchCodeDO.createdTs;
		deletedTs = theRefBranchCodeDO.deletedTs;
		updatedTs = theRefBranchCodeDO.updatedTs;
		updatedByUser = theRefBranchCodeDO.updatedByUser;
		updatedByTxnId = theRefBranchCodeDO.updatedByTxnId;
		configLanguageCodeKey = theRefBranchCodeDO.configLanguageCodeKey;
		key = theRefBranchCodeDO.key;
		value = theRefBranchCodeDO.value;
		description = theRefBranchCodeDO.description;
		inquiryFilter = theRefBranchCodeDO.inquiryFilter;
	}
