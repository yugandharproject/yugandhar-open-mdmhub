...
/**
 * Abstract DO class for RefLobtypeDO class mapped to database REF_LOBTYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefLobtypeDO
*/

@MappedSuperclass
public abstract class AbstractRefLobtypeDO implements java.io.Serializable {
	...
	public AbstractRefLobtypeDO() {
	}

	public AbstractRefLobtypeDO(RefLobtypeDO theRefLobtypeDO) {
		idPk = theRefLobtypeDO.idPk;
		version = theRefLobtypeDO.version;
		createdTs = theRefLobtypeDO.createdTs;
		deletedTs = theRefLobtypeDO.deletedTs;
		updatedTs = theRefLobtypeDO.updatedTs;
		updatedByUser = theRefLobtypeDO.updatedByUser;
		updatedByTxnId = theRefLobtypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefLobtypeDO.configLanguageCodeKey;
		key = theRefLobtypeDO.key;
		value = theRefLobtypeDO.value;
		description = theRefLobtypeDO.description;
		inquiryFilter = theRefLobtypeDO.inquiryFilter;
	}
