...
/**
 * Abstract DO class for AuthUserRegistryDO class mapped to database AUTH_USER_REGISTRY entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.AuthUserRegistryDO
*/

@MappedSuperclass
public abstract class AbstractAuthUserRegistryDO implements java.io.Serializable {
	...
	public AbstractAuthUserRegistryDO() {
	}

	public AbstractAuthUserRegistryDO(AuthUserRegistryDO theAuthUserRegistryDO) {
		idPk = theAuthUserRegistryDO.idPk;
		version = theAuthUserRegistryDO.version;
		createdTs = theAuthUserRegistryDO.createdTs;
		deletedTs = theAuthUserRegistryDO.deletedTs;
		updatedTs = theAuthUserRegistryDO.updatedTs;
		updatedByUser = theAuthUserRegistryDO.updatedByUser;
		updatedByTxnId = theAuthUserRegistryDO.updatedByTxnId;
		userName = theAuthUserRegistryDO.userName;
		description = theAuthUserRegistryDO.description;
		inquiryFilter = theAuthUserRegistryDO.inquiryFilter;
	}
	...
	@Column(name = "USER_NAME", unique = true, nullable = false, length = 400)
