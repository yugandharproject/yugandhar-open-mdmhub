...
/**
 * Abstract DO class for RefCurrencyDO class mapped to database REF_CURRENCY entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefCurrencyDO
*/

@MappedSuperclass
public abstract class AbstractRefCurrencyDO implements java.io.Serializable {
	...
	public AbstractRefCurrencyDO() {
	}

	public AbstractRefCurrencyDO(RefCurrencyDO theRefCurrencyDO) {
		idPk = theRefCurrencyDO.idPk;
		version = theRefCurrencyDO.version;
		createdTs = theRefCurrencyDO.createdTs;
		deletedTs = theRefCurrencyDO.deletedTs;
		updatedTs = theRefCurrencyDO.updatedTs;
		updatedByUser = theRefCurrencyDO.updatedByUser;
		updatedByTxnId = theRefCurrencyDO.updatedByTxnId;
		configLanguageCodeKey = theRefCurrencyDO.configLanguageCodeKey;
		key = theRefCurrencyDO.key;
		value = theRefCurrencyDO.value;
		description = theRefCurrencyDO.description;
		inquiryFilter = theRefCurrencyDO.inquiryFilter;
	}
