...
/**
 * Abstract DO class for RefRelationshipStatusDO class mapped to database REF_RELATIONSHIP_STATUS entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefRelationshipStatusDO
*/

@MappedSuperclass
public abstract class AbstractRefRelationshipStatusDO implements java.io.Serializable {
	...
	public AbstractRefRelationshipStatusDO() {
	}

	public AbstractRefRelationshipStatusDO(RefRelationshipStatusDO theRefRelationshipStatusDO) {
		idPk = theRefRelationshipStatusDO.idPk;
		version = theRefRelationshipStatusDO.version;
		createdTs = theRefRelationshipStatusDO.createdTs;
		deletedTs = theRefRelationshipStatusDO.deletedTs;
		updatedTs = theRefRelationshipStatusDO.updatedTs;
		updatedByUser = theRefRelationshipStatusDO.updatedByUser;
		updatedByTxnId = theRefRelationshipStatusDO.updatedByTxnId;
		configLanguageCodeKey = theRefRelationshipStatusDO.configLanguageCodeKey;
		key = theRefRelationshipStatusDO.key;
		value = theRefRelationshipStatusDO.value;
		description = theRefRelationshipStatusDO.description;
		inquiryFilter = theRefRelationshipStatusDO.inquiryFilter;
	}
