...
/**
 * Abstract DO class for RefBillingModeTypeDO class mapped to database REF_BILLING_MODE_TYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefBillingModeTypeDO
*/

@MappedSuperclass
public abstract class AbstractRefBillingModeTypeDO implements java.io.Serializable {
	...
	public AbstractRefBillingModeTypeDO() {
	}

	public AbstractRefBillingModeTypeDO(RefBillingModeTypeDO theRefBillingModeTypeDO) {
		idPk = theRefBillingModeTypeDO.idPk;
		version = theRefBillingModeTypeDO.version;
		createdTs = theRefBillingModeTypeDO.createdTs;
		deletedTs = theRefBillingModeTypeDO.deletedTs;
		updatedTs = theRefBillingModeTypeDO.updatedTs;
		updatedByUser = theRefBillingModeTypeDO.updatedByUser;
		updatedByTxnId = theRefBillingModeTypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefBillingModeTypeDO.configLanguageCodeKey;
		key = theRefBillingModeTypeDO.key;
		value = theRefBillingModeTypeDO.value;
		description = theRefBillingModeTypeDO.description;
		inquiryFilter = theRefBillingModeTypeDO.inquiryFilter;
	}
