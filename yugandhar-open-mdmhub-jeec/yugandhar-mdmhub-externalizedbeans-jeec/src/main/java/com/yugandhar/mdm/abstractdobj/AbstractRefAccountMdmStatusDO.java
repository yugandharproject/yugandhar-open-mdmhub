...
/**
 * Abstract DO class for RefAccountMdmStatusDO class mapped to database REF_ACCOUNT_MDM_STATUS entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefAccountMdmStatusDO
*/

@MappedSuperclass
public abstract class AbstractRefAccountMdmStatusDO implements java.io.Serializable {
	...
	public AbstractRefAccountMdmStatusDO() {
	}

	public AbstractRefAccountMdmStatusDO(RefAccountMdmStatusDO theRefAccountMdmStatusDO) {
		idPk = theRefAccountMdmStatusDO.idPk;
		version = theRefAccountMdmStatusDO.version;
		createdTs = theRefAccountMdmStatusDO.createdTs;
		deletedTs = theRefAccountMdmStatusDO.deletedTs;
		updatedTs = theRefAccountMdmStatusDO.updatedTs;
		updatedByUser = theRefAccountMdmStatusDO.updatedByUser;
		updatedByTxnId = theRefAccountMdmStatusDO.updatedByTxnId;
		configLanguageCodeKey = theRefAccountMdmStatusDO.configLanguageCodeKey;
		key = theRefAccountMdmStatusDO.key;
		value = theRefAccountMdmStatusDO.value;
		description = theRefAccountMdmStatusDO.description;
		inquiryFilter = theRefAccountMdmStatusDO.inquiryFilter;
	}
