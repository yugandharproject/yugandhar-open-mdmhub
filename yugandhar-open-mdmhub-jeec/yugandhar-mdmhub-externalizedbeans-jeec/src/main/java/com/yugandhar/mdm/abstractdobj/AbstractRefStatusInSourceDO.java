...
/**
 * Abstract DO class for RefStatusInSourceDO class mapped to database REF_STATUS_IN_SOURCE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefStatusInSourceDO
*/

@MappedSuperclass
public abstract class AbstractRefStatusInSourceDO implements java.io.Serializable {
	...
	public AbstractRefStatusInSourceDO() {
	}

	public AbstractRefStatusInSourceDO(RefStatusInSourceDO theRefStatusInSourceDO) {
		idPk = theRefStatusInSourceDO.idPk;
		version = theRefStatusInSourceDO.version;
		createdTs = theRefStatusInSourceDO.createdTs;
		deletedTs = theRefStatusInSourceDO.deletedTs;
		updatedTs = theRefStatusInSourceDO.updatedTs;
		updatedByUser = theRefStatusInSourceDO.updatedByUser;
		updatedByTxnId = theRefStatusInSourceDO.updatedByTxnId;
		configLanguageCodeKey = theRefStatusInSourceDO.configLanguageCodeKey;
		key = theRefStatusInSourceDO.key;
		value = theRefStatusInSourceDO.value;
		description = theRefStatusInSourceDO.description;
		inquiryFilter = theRefStatusInSourceDO.inquiryFilter;
	}
