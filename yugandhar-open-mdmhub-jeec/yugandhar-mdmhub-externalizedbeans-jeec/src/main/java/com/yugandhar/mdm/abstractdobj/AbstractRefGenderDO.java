...
/**
 * Abstract DO class for RefGenderDO class mapped to database REF_GENDER entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefGenderDO
*/

@MappedSuperclass
public abstract class AbstractRefGenderDO implements java.io.Serializable {
	...
	public AbstractRefGenderDO() {
	}

	public AbstractRefGenderDO(RefGenderDO theRefGenderDO) {
		idPk = theRefGenderDO.idPk;
		version = theRefGenderDO.version;
		createdTs = theRefGenderDO.createdTs;
		deletedTs = theRefGenderDO.deletedTs;
		updatedTs = theRefGenderDO.updatedTs;
		updatedByUser = theRefGenderDO.updatedByUser;
		updatedByTxnId = theRefGenderDO.updatedByTxnId;
		configLanguageCodeKey = theRefGenderDO.configLanguageCodeKey;
		key = theRefGenderDO.key;
		value = theRefGenderDO.value;
		description = theRefGenderDO.description;
		inquiryFilter = theRefGenderDO.inquiryFilter;
	}
