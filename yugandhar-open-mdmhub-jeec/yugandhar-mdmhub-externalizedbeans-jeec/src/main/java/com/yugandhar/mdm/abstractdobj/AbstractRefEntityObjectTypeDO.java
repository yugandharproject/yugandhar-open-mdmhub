...
/**
 * Abstract DO class for RefEntityObjectTypeDO class mapped to database REF_ENTITY_OBJECT_TYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefEntityObjectTypeDO
*/

@MappedSuperclass
public abstract class AbstractRefEntityObjectTypeDO implements java.io.Serializable {
	...
	public AbstractRefEntityObjectTypeDO() {
	}

	public AbstractRefEntityObjectTypeDO(RefEntityObjectTypeDO theRefEntityObjectTypeDO) {
		idPk = theRefEntityObjectTypeDO.idPk;
		version = theRefEntityObjectTypeDO.version;
		createdTs = theRefEntityObjectTypeDO.createdTs;
		deletedTs = theRefEntityObjectTypeDO.deletedTs;
		updatedTs = theRefEntityObjectTypeDO.updatedTs;
		updatedByUser = theRefEntityObjectTypeDO.updatedByUser;
		updatedByTxnId = theRefEntityObjectTypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefEntityObjectTypeDO.configLanguageCodeKey;
		key = theRefEntityObjectTypeDO.key;
		value = theRefEntityObjectTypeDO.value;
		description = theRefEntityObjectTypeDO.description;
		inquiryFilter = theRefEntityObjectTypeDO.inquiryFilter;
	}
