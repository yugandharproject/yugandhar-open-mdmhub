...
/**
 * Abstract DO class for RefPropertyLeReltypeDO class mapped to database REF_PROPERTY_LE_RELTYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefPropertyLeReltypeDO
*/

@MappedSuperclass
public abstract class AbstractRefPropertyLeReltypeDO implements java.io.Serializable {
	...
	public AbstractRefPropertyLeReltypeDO() {
	}

	public AbstractRefPropertyLeReltypeDO(RefPropertyLeReltypeDO theRefPropertyLeReltypeDO) {
		idPk = theRefPropertyLeReltypeDO.idPk;
		version = theRefPropertyLeReltypeDO.version;
		createdTs = theRefPropertyLeReltypeDO.createdTs;
		deletedTs = theRefPropertyLeReltypeDO.deletedTs;
		updatedTs = theRefPropertyLeReltypeDO.updatedTs;
		updatedByUser = theRefPropertyLeReltypeDO.updatedByUser;
		updatedByTxnId = theRefPropertyLeReltypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefPropertyLeReltypeDO.configLanguageCodeKey;
		key = theRefPropertyLeReltypeDO.key;
		value = theRefPropertyLeReltypeDO.value;
		description = theRefPropertyLeReltypeDO.description;
		inquiryFilter = theRefPropertyLeReltypeDO.inquiryFilter;
	}
