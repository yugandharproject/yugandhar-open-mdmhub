...
/**
 * Abstract DO class for RefCorporationNameTypeDO class mapped to database REF_CORPORATION_NAME_TYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefCorporationNameTypeDO
*/

@MappedSuperclass
public abstract class AbstractRefCorporationNameTypeDO implements java.io.Serializable {
	...
	public AbstractRefCorporationNameTypeDO() {
	}

	public AbstractRefCorporationNameTypeDO(RefCorporationNameTypeDO theRefCorporationNameTypeDO) {
		idPk = theRefCorporationNameTypeDO.idPk;
		version = theRefCorporationNameTypeDO.version;
		createdTs = theRefCorporationNameTypeDO.createdTs;
		deletedTs = theRefCorporationNameTypeDO.deletedTs;
		updatedTs = theRefCorporationNameTypeDO.updatedTs;
		updatedByUser = theRefCorporationNameTypeDO.updatedByUser;
		updatedByTxnId = theRefCorporationNameTypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefCorporationNameTypeDO.configLanguageCodeKey;
		key = theRefCorporationNameTypeDO.key;
		value = theRefCorporationNameTypeDO.value;
		description = theRefCorporationNameTypeDO.description;
		inquiryFilter = theRefCorporationNameTypeDO.inquiryFilter;
	}
