...
/**
 * Abstract DO class for RefMatchResultDO class mapped to database REF_MATCH_RESULT entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefMatchResultDO
*/

@MappedSuperclass
public abstract class AbstractRefMatchResultDO implements java.io.Serializable {
	...
	public AbstractRefMatchResultDO() {
	}

	public AbstractRefMatchResultDO(RefMatchResultDO theRefMatchResultDO) {
		idPk = theRefMatchResultDO.idPk;
		version = theRefMatchResultDO.version;
		createdTs = theRefMatchResultDO.createdTs;
		deletedTs = theRefMatchResultDO.deletedTs;
		updatedTs = theRefMatchResultDO.updatedTs;
		updatedByUser = theRefMatchResultDO.updatedByUser;
		updatedByTxnId = theRefMatchResultDO.updatedByTxnId;
		configLanguageCodeKey = theRefMatchResultDO.configLanguageCodeKey;
		key = theRefMatchResultDO.key;
		value = theRefMatchResultDO.value;
		description = theRefMatchResultDO.description;
		inquiryFilter = theRefMatchResultDO.inquiryFilter;
	}
