...
/**
 * Abstract DO class for RefMatchProposedActionDO class mapped to database REF_MATCH_PROPOSED_ACTION entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefMatchProposedActionDO
*/

@MappedSuperclass
public abstract class AbstractRefMatchProposedActionDO implements java.io.Serializable {
	...
	public AbstractRefMatchProposedActionDO() {
	}

	public AbstractRefMatchProposedActionDO(RefMatchProposedActionDO theRefMatchProposedActionDO) {
		idPk = theRefMatchProposedActionDO.idPk;
		version = theRefMatchProposedActionDO.version;
		createdTs = theRefMatchProposedActionDO.createdTs;
		deletedTs = theRefMatchProposedActionDO.deletedTs;
		updatedTs = theRefMatchProposedActionDO.updatedTs;
		updatedByUser = theRefMatchProposedActionDO.updatedByUser;
		updatedByTxnId = theRefMatchProposedActionDO.updatedByTxnId;
		configLanguageCodeKey = theRefMatchProposedActionDO.configLanguageCodeKey;
		key = theRefMatchProposedActionDO.key;
		value = theRefMatchProposedActionDO.value;
		description = theRefMatchProposedActionDO.description;
		inquiryFilter = theRefMatchProposedActionDO.inquiryFilter;
	}
