...
/**
 * Abstract DO class for SearchAccountRequestDO used for searching Account
*@author Yugandhar
*@version 1.0
*@since 1.0
*/

public abstract class AbstractSearchAccountRequestDO implements java.io.Serializable {
