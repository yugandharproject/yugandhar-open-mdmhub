...
/**
 * Abstract DO class for LeAddressAssocDO class mapped to database
 * LE_ADDRESS_ASSOC entity
 * 
 * @author Yugandhar
 * @version 1.0
 * @since 1.0
 * @see com.yugandhar.mdm.extern.dobj.LeAddressAssocDO
 */

@MappedSuperclass
public abstract class AbstractLeAddressAssocDO implements java.io.Serializable {
	...
	public AbstractLeAddressAssocDO() {
	}

	public AbstractLeAddressAssocDO(LeAddressAssocDO theLeAddressAssocDO) {
		idPk = theLeAddressAssocDO.idPk;
		version = theLeAddressAssocDO.version;
		createdTs = theLeAddressAssocDO.createdTs;
		deletedTs = theLeAddressAssocDO.deletedTs;
		updatedTs = theLeAddressAssocDO.updatedTs;
		updatedByUser = theLeAddressAssocDO.updatedByUser;
		updatedByTxnId = theLeAddressAssocDO.updatedByTxnId;
		legalentityIdpk = theLeAddressAssocDO.legalentityIdpk;
		addressIdpk = theLeAddressAssocDO.addressIdpk;
		addressTypeRefkey = theLeAddressAssocDO.addressTypeRefkey;
		addressSubtypeRefkey = theLeAddressAssocDO.addressSubtypeRefkey;
		preferredFlag = theLeAddressAssocDO.preferredFlag;
		solicitationFlag = theLeAddressAssocDO.solicitationFlag;
		inquiryFilter = theLeAddressAssocDO.inquiryFilter;
	}
	...
	/**
	 * @param addressTypeRefValue
	 *            the addressTypeRefValue to set
	 */
	...
	/**
	 * @param addressSubtypeRefValue
	 *            the addressSubtypeRefValue to set
	 */
