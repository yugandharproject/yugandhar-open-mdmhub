...
/**
 * Abstract DO class for RefSuffixNameDO class mapped to database REF_SUFFIX_NAME entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefSuffixNameDO
*/

@MappedSuperclass
public abstract class AbstractRefSuffixNameDO implements java.io.Serializable {
	...
	public AbstractRefSuffixNameDO() {
	}

	public AbstractRefSuffixNameDO(RefSuffixNameDO theRefSuffixNameDO) {
		idPk = theRefSuffixNameDO.idPk;
		version = theRefSuffixNameDO.version;
		createdTs = theRefSuffixNameDO.createdTs;
		deletedTs = theRefSuffixNameDO.deletedTs;
		updatedTs = theRefSuffixNameDO.updatedTs;
		updatedByUser = theRefSuffixNameDO.updatedByUser;
		updatedByTxnId = theRefSuffixNameDO.updatedByTxnId;
		configLanguageCodeKey = theRefSuffixNameDO.configLanguageCodeKey;
		key = theRefSuffixNameDO.key;
		value = theRefSuffixNameDO.value;
		description = theRefSuffixNameDO.description;
		inquiryFilter = theRefSuffixNameDO.inquiryFilter;
	}
