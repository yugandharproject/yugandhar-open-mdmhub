...
/* Generated Aug 8, 2017 3:00:14 PM by Hibernate Tools 5.2.1.Final using Yugandhar custom templates. 
...
/**
 * Abstract DO class for ConfigLanguageCodeDO class mapped to database CONFIG_LANGUAGE_CODE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.ConfigLanguageCodeDO
*/

@MappedSuperclass
public abstract class AbstractConfigLanguageCodeDO implements java.io.Serializable {
	...
	public AbstractConfigLanguageCodeDO() {
	}
