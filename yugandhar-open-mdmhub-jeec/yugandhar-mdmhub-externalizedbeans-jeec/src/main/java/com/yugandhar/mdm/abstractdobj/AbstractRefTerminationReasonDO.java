...
/**
 * Abstract DO class for RefTerminationReasonDO class mapped to database REF_TERMINATION_REASON entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefTerminationReasonDO
*/

@MappedSuperclass
public abstract class AbstractRefTerminationReasonDO implements java.io.Serializable {
	...
	public AbstractRefTerminationReasonDO() {
	}

	public AbstractRefTerminationReasonDO(RefTerminationReasonDO theRefTerminationReasonDO) {
		idPk = theRefTerminationReasonDO.idPk;
		version = theRefTerminationReasonDO.version;
		createdTs = theRefTerminationReasonDO.createdTs;
		deletedTs = theRefTerminationReasonDO.deletedTs;
		updatedTs = theRefTerminationReasonDO.updatedTs;
		updatedByUser = theRefTerminationReasonDO.updatedByUser;
		updatedByTxnId = theRefTerminationReasonDO.updatedByTxnId;
		configLanguageCodeKey = theRefTerminationReasonDO.configLanguageCodeKey;
		key = theRefTerminationReasonDO.key;
		value = theRefTerminationReasonDO.value;
		description = theRefTerminationReasonDO.description;
		inquiryFilter = theRefTerminationReasonDO.inquiryFilter;
	}
