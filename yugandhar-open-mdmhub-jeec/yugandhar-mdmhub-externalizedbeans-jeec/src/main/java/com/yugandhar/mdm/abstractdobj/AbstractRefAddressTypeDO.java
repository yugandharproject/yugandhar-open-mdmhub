...
/**
 * Abstract DO class for RefAddressTypeDO class mapped to database REF_ADDRESS_TYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefAddressTypeDO
*/

@MappedSuperclass
public abstract class AbstractRefAddressTypeDO implements java.io.Serializable {
	...
	public AbstractRefAddressTypeDO() {
	}

	public AbstractRefAddressTypeDO(RefAddressTypeDO theRefAddressTypeDO) {
		idPk = theRefAddressTypeDO.idPk;
		version = theRefAddressTypeDO.version;
		createdTs = theRefAddressTypeDO.createdTs;
		deletedTs = theRefAddressTypeDO.deletedTs;
		updatedTs = theRefAddressTypeDO.updatedTs;
		updatedByUser = theRefAddressTypeDO.updatedByUser;
		updatedByTxnId = theRefAddressTypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefAddressTypeDO.configLanguageCodeKey;
		key = theRefAddressTypeDO.key;
		value = theRefAddressTypeDO.value;
		description = theRefAddressTypeDO.description;
		inquiryFilter = theRefAddressTypeDO.inquiryFilter;
	}
