...
/**
 * Abstract DO class for RefLeRelationshipTypeDO class mapped to database REF_LE_RELATIONSHIP_TYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefLeRelationshipTypeDO
*/

@MappedSuperclass
public abstract class AbstractRefLeRelationshipTypeDO implements java.io.Serializable {
	...
	public AbstractRefLeRelationshipTypeDO() {
	}

	public AbstractRefLeRelationshipTypeDO(RefLeRelationshipTypeDO theRefLeRelationshipTypeDO) {
		idPk = theRefLeRelationshipTypeDO.idPk;
		version = theRefLeRelationshipTypeDO.version;
		createdTs = theRefLeRelationshipTypeDO.createdTs;
		deletedTs = theRefLeRelationshipTypeDO.deletedTs;
		updatedTs = theRefLeRelationshipTypeDO.updatedTs;
		updatedByUser = theRefLeRelationshipTypeDO.updatedByUser;
		updatedByTxnId = theRefLeRelationshipTypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefLeRelationshipTypeDO.configLanguageCodeKey;
		key = theRefLeRelationshipTypeDO.key;
		value = theRefLeRelationshipTypeDO.value;
		description = theRefLeRelationshipTypeDO.description;
		inquiryFilter = theRefLeRelationshipTypeDO.inquiryFilter;
	}
