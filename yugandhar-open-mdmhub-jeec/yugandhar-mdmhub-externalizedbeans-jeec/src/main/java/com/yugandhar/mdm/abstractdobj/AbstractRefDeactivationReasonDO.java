...
/**
 * Abstract DO class for RefDeactivationReasonDO class mapped to database REF_DEACTIVATION_REASON entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefDeactivationReasonDO
*/

@MappedSuperclass
public abstract class AbstractRefDeactivationReasonDO implements java.io.Serializable {
	...
	public AbstractRefDeactivationReasonDO() {
	}

	public AbstractRefDeactivationReasonDO(RefDeactivationReasonDO theRefDeactivationReasonDO) {
		idPk = theRefDeactivationReasonDO.idPk;
		version = theRefDeactivationReasonDO.version;
		createdTs = theRefDeactivationReasonDO.createdTs;
		deletedTs = theRefDeactivationReasonDO.deletedTs;
		updatedTs = theRefDeactivationReasonDO.updatedTs;
		updatedByUser = theRefDeactivationReasonDO.updatedByUser;
		updatedByTxnId = theRefDeactivationReasonDO.updatedByTxnId;
		configLanguageCodeKey = theRefDeactivationReasonDO.configLanguageCodeKey;
		key = theRefDeactivationReasonDO.key;
		value = theRefDeactivationReasonDO.value;
		description = theRefDeactivationReasonDO.description;
		inquiryFilter = theRefDeactivationReasonDO.inquiryFilter;
	}
