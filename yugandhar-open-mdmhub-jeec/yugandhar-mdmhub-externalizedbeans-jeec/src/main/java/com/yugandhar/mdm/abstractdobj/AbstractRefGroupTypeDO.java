...
/**
 * Abstract DO class for RefGroupTypeDO class mapped to database REF_GROUP_TYPE entity
*@author Yugandhar
*@version 1.0
*@since 1.0
*@see com.yugandhar.mdm.extern.dobj.RefGroupTypeDO
*/

@MappedSuperclass
public abstract class AbstractRefGroupTypeDO implements java.io.Serializable {
	...
	public AbstractRefGroupTypeDO() {
	}

	public AbstractRefGroupTypeDO(RefGroupTypeDO theRefGroupTypeDO) {
		idPk = theRefGroupTypeDO.idPk;
		version = theRefGroupTypeDO.version;
		createdTs = theRefGroupTypeDO.createdTs;
		deletedTs = theRefGroupTypeDO.deletedTs;
		updatedTs = theRefGroupTypeDO.updatedTs;
		updatedByUser = theRefGroupTypeDO.updatedByUser;
		updatedByTxnId = theRefGroupTypeDO.updatedByTxnId;
		configLanguageCodeKey = theRefGroupTypeDO.configLanguageCodeKey;
		key = theRefGroupTypeDO.key;
		value = theRefGroupTypeDO.value;
		description = theRefGroupTypeDO.description;
		inquiryFilter = theRefGroupTypeDO.inquiryFilter;
	}
