...
public class YugDefaultRequestQueueListener {
	...
	@JmsListener(containerFactory = "yugJNDIDestJmsListenerContainerFactory", destination="java:jboss/com/yugandhar/default/requestQueue") //YUG.DEFAULT.REQUEST
...
//	Jackson2ObjectMapperBuilder theJackson2ObjectMapperBuilder = new Jackson2ObjectMapperBuilder();
//	ObjectMapper yugMapper = theJackson2ObjectMapperBuilder.build();
//	yugMapper.setPropertyInclusion(
//			JsonInclude.Value.construct(JsonInclude.Include.NON_NULL, JsonInclude.Include.NON_NULL));
//	SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd'T'HH.mm.ss.SSSZ");
//	TimeZone tz = TimeZone.getTimeZone("GMT");
//
//	yugMapper.setDateFormat(df);
//	yugMapper.setTimeZone(tz);
//	return yugMapper;
