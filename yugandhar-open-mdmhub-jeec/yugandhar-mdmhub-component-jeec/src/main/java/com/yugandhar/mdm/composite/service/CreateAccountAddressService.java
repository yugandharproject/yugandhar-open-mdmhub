...
@Service("com.yugandhar.mdm.composite.service.CreateAccountAddressService")
public class CreateAccountAddressService {
	...
	TxnPayload transitTxnPayload;
		...
		public CreateAccountAddressService() {
		...
		public TxnTransferObj process(TxnTransferObj txnTransferObj) throws YugandharCommonException {
			...
			try {
				...
				transitTxnTransferObj.setTxnPayload(transitTxnPayload);
				transitTxnTransferObj = accountAddressAssocComponent.persist(transitTxnTransferObj);
			...
			if (null == txnTransferObj.getTxnPayload().getAccountAddressAssocDO().getAccountIdpk() || 
				...
				transitTxnTransferObj = accountComponent.findById(transitTxnTransferObj);
					...
					throw commonValidationUtil.populateErrorResponse(txnTransferObj, "1", re,
							"CreateAccountAddressService.validateRequestAccountAddressAssocDO failed unexpectedly"); //Transaction Failed due to unknown error, please check statck trace
				}
