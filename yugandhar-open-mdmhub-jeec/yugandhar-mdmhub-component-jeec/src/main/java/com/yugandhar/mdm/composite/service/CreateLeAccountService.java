...
@Service("com.yugandhar.mdm.composite.service.CreateLeAccountService")
public class CreateLeAccountService {
	...
	public TxnTransferObj process(TxnTransferObj txnTransferObj) throws YugandharCommonException {
		...
		try {
			...
			// if Account Id is null then create new Account in database
			...
			transitTxnTransferObj.setTxnPayload(transitTxnPayload);
			transitTxnTransferObj = leAccountAssocComponent.persist(transitTxnTransferObj);
