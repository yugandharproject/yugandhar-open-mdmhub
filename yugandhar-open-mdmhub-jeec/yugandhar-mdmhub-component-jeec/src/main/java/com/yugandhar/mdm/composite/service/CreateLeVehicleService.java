...
@Service("com.yugandhar.mdm.composite.service.CreateLeVehicleService")
public class CreateLeVehicleService {
	...
	TxnPayload transitTxnPayload;
		...
		public TxnTransferObj process(TxnTransferObj txnTransferObj) throws YugandharCommonException {
			...
			try {
				...
				// if Vehicle Id is null then process Vehicle Object
				...
				transitTxnTransferObj.setTxnPayload(transitTxnPayload);
				transitTxnTransferObj = leVehicleAssocComponent.persist(transitTxnTransferObj);
