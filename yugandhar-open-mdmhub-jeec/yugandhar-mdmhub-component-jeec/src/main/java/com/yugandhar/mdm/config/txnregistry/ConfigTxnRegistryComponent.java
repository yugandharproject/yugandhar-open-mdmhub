	...
	*/
	...
	public TxnTransferObj findByBusinessKey(TxnTransferObj txnTransferObj) {
		...
		try {
			...
			mqReqResplogger.info("Printing reqConfigTxnRegistryDO: TxnMessageId|" + txnTransferObj.getTxnHeader().getTxnMessageId() + reqConfigTxnRegistryDO.getTxnserviceName() + reqConfigTxnRegistryDO.getInquiryFilter() + dbimageConfigTxnRegistryDO.getTxnserviceClass() );
