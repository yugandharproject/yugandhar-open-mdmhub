...
@Service("com.yugandhar.mdm.composite.service.CreateEntityGroupService")
public class CreateEntityGroupService {
	...
	public CreateEntityGroupService() {
	...
	public TxnTransferObj process(TxnTransferObj txnTransferObj) throws YugandharCommonException {
		...
		try {
			...
			transitTxnTransferObj = entityGroupComponent.persist(transitTxnTransferObj);
